...
IconData nodeTypeIcon(String typeKey) {
  return switch (typeKey) {
    ...
    'file.hardLink' => FluentIcons.add_link,
    'file.readHex' => FluentIcons.code,
    'file.writeHex' => FluentIcons.code_edit,
    'process.run' => FluentIcons.process,
    'process.runScript' => FluentIcons.command_prompt,
    'context.macro' => FluentIcons.variable,
    'context.environment' => FluentIcons.globe,
    'context.packageFile' => FluentIcons.file_symlink,
    'context.scriptFile' => FluentIcons.script,
    ...
    'string.upperCase' => FluentIcons.font_increase,
    ...
    'logic.compareNumber' => FluentIcons.calculator_equal_to,
    'logic.not' => FluentIcons.cancel,
    'math.arithmetic' => FluentIcons.calculator_addition,
    'math.bitwise' => FluentIcons.calculator_delta,
    ...
    'system.findTool' => FluentIcons.toolbox,
    'system.download' => FluentIcons.download,
    'system.upload' => FluentIcons.upload,
    'variable.setNumber' => FluentIcons.save,
    'variable.getNumber' => FluentIcons.open_file,
    'variable.setString' => FluentIcons.save_as,
    'variable.getString' => FluentIcons.read,
