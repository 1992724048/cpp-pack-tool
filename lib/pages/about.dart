      ...
      child: Center(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Image.asset('assets/icons/logo.png', width: 128, height: 128),
              const SizedBox(height: 16),
              Text(appName, style: theme.typography.titleLarge?.copyWith(fontWeight: FontWeight.w600)),
              ...
              FilledButton(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [Svgs.openBox, const SizedBox(width: 8), const Text('项目主页')],
                ),
              ),
              const SizedBox(height: 24),
              Text('第三方组件许可见仓库 THIRD_PARTY_NOTICES.md', style: TextStyle(color: secondaryColor, fontSize: 12)),
            ],
          ),
        ),
      ),
